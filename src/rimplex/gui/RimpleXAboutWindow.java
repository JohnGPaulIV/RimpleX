...
public class RimpleXAboutWindow extends JFrame
{
  ...
  private final String imgFile = "/icons/iconRimplex.png";
  private final String rV = "Rimplex v1.0";
  private final String r = " RimpleX";
  private final String a = "RimpleX_About";
  /**
  * Constructs "About" Window for Rimplex.
  */
  public RimpleXAboutWindow() throws IOException
  {
    setTitle(rb.getString(about) + r);
    setSize(400, 275);
    ...
    try
    {
     // Add title and RimpleX icon to the About Window.
      ...
      add(titleLabel);
      BufferedImage icon = ImageIO.read(getClass().getResource(imgFile));
    
      // sets the window icon.
      ImageIcon img = new ImageIcon(getClass().getResource(imgFile));
