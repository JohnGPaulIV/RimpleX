...
public class ComplexTest
{
 ...
 @Test
 public void testGreaterThan_realGreater()
 {
 ...
 @Test
 public void testGreaterThan_realEqual_imagGreater()
 {
 ...
 @Test
 public void testGreaterThan_realEqual_imagEqual()
 {
   Complex a = new Complex(5.0, 3.0);
 ...
 @Test
 public void testGreaterThan_realEqual_imagLess()
 {
   Complex a = new Complex(5.0, 1.0);
   Complex b = new Complex(5.0, 2.0);
   assertFalse(a.greaterThan(b));
 }
 @Test
 public void testGreaterThan_realLess()
 {
 ...
 @Test
 public void testLessThan_realLess()
 {
 ...
 @Test
 public void testLessThan_realEqual_imagLess()
 {
 ...
 @Test
 public void testLessThan_realEqual_imagEqual()
 {
 ...
 @Test
 public void testLessThan_realEqual_imagGreater()
 {
 ...
 @Test
 public void testLessThan_realGreater()
 {
   Complex a = new Complex(6.0, 2.0);
   Complex b = new Complex(5.0, 3.0);
   assertFalse(a.lessThan(b));
 }
 @SuppressWarnings("deprecation")
 @Test
 public void testParseSpanishLocale()
 {
   Locale.setDefault(new Locale("es"));
   Complex c = Complex.parse("1,5+2,5𝑖");
   assertEquals(1.5, c.getReal(), 0.0001);
   assertEquals(2.5, c.getImaginary(), 0.0001);
 }
 @SuppressWarnings("deprecation")
 @Test
 public void testParseRussianLocale()
 {
   Locale.setDefault(new Locale("ru"));
   Complex c = Complex.parse("1234,56+7,89𝑖");
   assertEquals(1234.56, c.getReal(), 0.0001);
   assertEquals(7.89, c.getImaginary(), 0.0001);
 }
 @Test
 public void testParseDefaultLocale()
 {
   Locale.setDefault(Locale.US);
   Complex c = Complex.parse("1,234.56+7.89𝑖");
   assertEquals(1234.56, c.getReal(), 0.0001);
   assertEquals(7.89, c.getImaginary(), 0.0001);
 }
}